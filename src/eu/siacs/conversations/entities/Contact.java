...
public class Contact implements ListItem, Blockable {
	...
	public Drawable getStatusImage(Context context){
		...
		case Presences.CHAT:
		case Presences.ONLINE:
			return context.getResources().getDrawable(R.drawable.available);
		case Presences.AWAY:
			return context.getResources().getDrawable(R.drawable.away);
		case Presences.XA:
			return context.getResources().getDrawable(R.drawable.idle);

		case Presences.DND:
			return context.getResources().getDrawable(R.drawable.busy);

	}
		return context.getResources().getDrawable(R.drawable.offline);
