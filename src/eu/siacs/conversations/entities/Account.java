...
public class Account extends AbstractEntity {
	...
	public Account(final Jid jid, final String password,String email) {
		this(java.util.UUID.randomUUID().toString(), jid,
				password, 0, null, "", null);
		this.email=email;
	}
	public Account(final Jid jid, final String password,String email,String name) {
		this(java.util.UUID.randomUUID().toString(), jid,
				password, 0, null, "", null);
		this.email=email;
		this.name=name;
	...
	public Account(final String uuid, final Jid jid,
			final String password, final int options, final String rosterVersion, final String keys,
			final String avatar,final String email) {
		this.uuid = uuid;
		this.jid = jid;
		if (jid.isBareJid()) {
			this.setResource("mobile");
