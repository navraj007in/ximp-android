...
public class ConversationActivity extends XmppActivity
		...
		if (isConversationsOverviewVisable() && isConversationsOverviewHideable()) {
		 ...
		 MenuItem item = menu.findItem(R.id.menu_item_share);
		    ...
		    String playStoreLink = "https://play.google.com/store/apps/details?id=" +
		        getPackageName();
		    String yourShareText = "I am using xChat to use chat rooms and discover" +
		    		" fellow chatter. Install it here " + playStoreLink;
		...
		if (item.getItemId() == android.R.id.home) {
			...
			switch (item.getItemId()) {
				...
				case R.id.action_unblock:
					BlockContactDialog.show(this, xmppConnectionService, getSelectedConversation());
					break;
				case R.id.action_changebackground:
					Intent i = new Intent(
	...
	void onBackendConnected() {
		...
		boolean customBackground = 
				xmppConnectionService.getPreferences().getBoolean("background", false);
		if(customBackground){
			 String backgroundPath = getFilesDir().getAbsolutePath()+"/background.png";

			Bitmap bitmap = Utils.GetBitmap(backgroundPath);
            BitmapDrawable bp = new BitmapDrawable(bitmap);
	         ListView lstConversation = (ListView) findViewById(R.id.messages_view);

            lstConversation.setBackgroundDrawable(bp);
	...
	protected void onActivityResult(int requestCode, int resultCode,
		...
		if (resultCode == RESULT_OK) {
			...
			if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
	            ...
	            BitmapDrawable bp = new BitmapDrawable(yourSelectedImage);
		         Toast.makeText(getApplicationContext(), getResources().getString(R.string.background_changed), 
		        		 Toast.LENGTH_SHORT).show();
		         RelativeLayout layoutChat =
		        		 (RelativeLayout) findViewById(R.id.layoutConversation);
		         ListView lstConversation = (ListView) findViewById(R.id.messages_view);
		         String backgroundPath = getApplicationContext()
				   .getFilesDir().getAbsolutePath()+"/background.png";
		         Log.i(Utils.TAG, "PATH-"+backgroundPath);
		         Utils.SaveBitmap(backgroundPath, yourSelectedImage);
		         Utils.WritePreference(getApplicationContext(), "background", true);
		         xmppConnectionService.getPreferences().edit().
		         		putBoolean("background",true).commit();
		         lstConversation.setBackgroundDrawable(bp);
		     }
		} else {
