...
public class PresenceParser extends AbstractParser implements
	...
	public void parseContactPresence(PresencePacket packet, Account account) {
		...
		Log.i(Utils.TAG, "Presence"+packet.toString());
		...
		if (type == null) {
			...
			if (pgp != null) {
				...
				if (status != null) {
					...
					if(msg!=null)
						if(msg.length()>0)
							Utils.getStatusMap().put(packet.
									getFrom().toBareJid().toString(), msg);
					Log.i(Utils.TAG, "Status -Wrote Presence for " +
							packet.getFrom().toBareJid().toString()+msg);
				} else {
					msg = "";
				}
