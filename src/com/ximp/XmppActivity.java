...
public abstract class XmppActivity extends Activity {
	...
	//	FlurryAgent.onStartSession(this, com.kss.xchat.Config.FLURRY_APP_ID);
	}

	protected static void loadBannerAd(){
		if(adView==null){
			adView = new AdView(xChat.getInstance());
	...
	protected void registerListeners() {
		...
		if (this instanceof XmppConnectionService.OnAvatarUpdate) {
			this.xmppConnectionService.setOnAvatarUpdateListener((XmppConnectionService.
					OnAvatarUpdate) this);
		}
